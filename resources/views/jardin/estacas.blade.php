            ...
            <div class="col-10 col-md-3 mb-3 no-gutters">
                <div class="card border-0 rounded-lg">
                    <div class="img-container p-0">
                        <a href="{{url('/exterior/estacas/'.Str::slug($item->first()['nombre'].'-xs'.$item->first()['idProducto']))}}">
                    ...
                    <div class="card-body pl-2 pr-2 pb-0 text-center">
                        ...
                        <a href="{{url('/exterior/estacas',Str::slug($item->first()['nombre'].'-xs'.$item->first()['idProducto'])) }}" class="btn green text-white mb-3"><i class="fas fa-eye"></i>Ver detalles</a>
