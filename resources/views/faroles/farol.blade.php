...
@section('content')
    ...
    <div class="container">
        @section('breadcrumbs')
            ...
            <li class="breadcrumb-item text-white active" aria-current="page">Farol</li>
        @endsection
        ...
        <div class="row no-gutters align-items-center">
            ...
            <div class="col-md-7">
                <div class="card-body ">
                     ...
                     <a href="{{ url('exterior/faroles') }}" class="btn btn-dark mb-3"><i class="fa fa-lightbulb"></i> Volver</a>
                </div>
            </div>
        </div>
    </div>
