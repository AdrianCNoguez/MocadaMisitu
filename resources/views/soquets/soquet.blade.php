...
@section('content')
    ...
    <div class="container">
        @section('breadcrumbs')
            ...
            <li class="breadcrumb-item text-white active" aria-current="page">Soquets</li>
        @endsection
            ...
            <div class="col-md-7">
                <div class="card-body">
                      ...
                      <ul>
                          ...
                          <li>Colores: {{ $product->color }}</li>
                          <li>Material: {{ $product->material }}</li>
                          <li>Tipo de rosca: {{ $product->tipoRosca }}</li>
                          <li>Medida de cable: {{ $product->largoCable }} </li>
                          
                      </ul>
                      <p><h2 class="d-inline">${{ $product->precio }}</h2> IVA incluido</p>
                      <a href="{{ url('componentes/soquets') }}" class="btn btn-dark mb-3"><i class="fa fa-lightbulb"></i> Volver</a>
                </div>
            </div>
        </div>
    </div>
