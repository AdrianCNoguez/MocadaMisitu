...
@section('content')
    ...
    <div class="card mb-3">
        <div class="row no-gutters align-items-center">
            ...
            <div class="col-md-7">
                <div class="card-body">
                      <h3 class="title-product">{{ $produc->nombre }}</h3>
                      <p class="card-text text-justify">{{ $produc->descripcion }}</p>
                      ...
                      <a href="{{ url('/') }}" class="btn btn-dark mb-3"><i class="fa fa-lightbulb"></i> Volver</a>
                </div>
            </div>
        </div>
    </div>
