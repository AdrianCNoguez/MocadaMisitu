...
@section('content')
    ...
    <div class="container">
        @section('breadcrumbs')
            <li class="breadcrumb-item text-white ctive" aria-current="page">Componetes Electricos</li>
            <li class="breadcrumb-item text-white active" aria-current="page">Extenciones</li>
        @endsection
